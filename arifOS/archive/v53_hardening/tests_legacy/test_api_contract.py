...
class TestStableAPIsExist:
    ...
    def test_top_level_metrics_exports(self):
        ...
        from arifos import Metrics, FloorsVerdict, ConstitutionalMetrics
    ...
    def test_top_level_eye_exports(self):
        ...
        from arifos import AlertSeverity, EyeAlert, EyeReport, EyeSentinel
    ...
    def test_top_level_trinity_exports(self):
        ...
        from arifos import AGI, ASI, evaluate_session
        from arifos import EvaluationResult, SentinelResult, ASIResult, EvaluationMode
    ...
    def test_top_level_red_patterns_exports(self):
        ...
        from arifos import RED_PATTERNS, RED_PATTERN_TO_FLOOR, RED_PATTERN_SEVERITY
...
class TestDeprecatedAPIsWarn:
    ...
    def test_sentinel_alias_deprecated(self):
        ...
        from arifos import Sentinel, AGI
    ...
    def test_accountant_alias_deprecated(self):
        ...
        from arifos import Accountant, ASI
...
class TestApexVerdictDataclass:
    ...
    def test_apex_verdict_has_verdict_field(self):
        ...
        from arifos import ApexVerdict, Verdict
...
class TestNoBreakingChanges:
    ...
    def test_basic_apex_review_flow(self):
        ...
        from arifos import apex_review, ApexVerdict, Verdict, Metrics
    ...
    def test_apex_verdict_convenience_shim(self):
        ...
        from arifos import apex_verdict, Metrics
